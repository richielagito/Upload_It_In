...
export default function CTA() {
  return (
    <section className="bg-gradient-to-br from-[#001E4D] via-foreground to-black text-white overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 opacity-40" />
      ...
      <div className="container mx-auto px-6 py-28 lg:py-40 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Ready for <span className="text-blue-400 italic">Better Feedback?</span>
          </motion.h2>
