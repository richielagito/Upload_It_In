                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                            {criteria.map((c, i) => (
                                <div
                                    key={i}
                                    className="flex items-center justify-between p-6 bg-white border-2 border-slate-50 rounded-3xl shadow-sm hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 group"
                                >
                                    <div>
                                        <p className="font-extrabold text-foreground text-lg font-headline group-hover:text-primary transition-colors">{c.name}</p>
                                        <p className="text-xs text-slate-400 font-bold uppercase tracking-widest font-sans mt-1">{c.weight}</p>
                                    </div>
                        ...
                        <div className="flex flex-wrap gap-6">
                            {result?.file_path && (
                                <div className="space-y-3 w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)]">
                                    ...
                                    {result.version && <p className="text-[10px] font-bold text-primary uppercase tracking-tight ml-1 italic">Version {result.version}</p>}
                                </div>
                            )}
                        </div>
                    </div>
